...
class UserSearchViewModel {
    ...
    func searchUsers(term: String) {
        ...
        // Chain a UI update after the task finishes
        searchWorkItem?.notify(queue: .main) {
            self.onResultShowAlert?()
            print("🎉 Notified on main queue. Updating UI...")
